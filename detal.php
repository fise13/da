...
$SITE_TITLE = 'Моторленд | '.$print['name'].' купить Алматы';
?>
<!doctype html>
<html>
<head>
...
<div class="generalw">
	<div class="shirina">
		...
		<div class="detalinlines">
			<div class="tovarimage" style="background-image: url(<?=get_farrimg($print['images'])[0];?>);">
		...
		<div class="detalinlines">
			<div class="tovertitle"><?=$print['name'];?></div>
